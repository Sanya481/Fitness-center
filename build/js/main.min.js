...
var subscriptionTabButtons = document.querySelectorAll('[data-tab-button]'); // Находим все поля ввода телефона и вешаем обработчик
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_vendor_js__WEBPACK_IMPORTED_MODULE_3__["checkCoachSwiper"])(); // Если таких кнопок нет - то ничего не происходит

  if (subscriptionTabButtons) {
    Object(_subscription_tab_js__WEBPACK_IMPORTED_MODULE_4__["changeSubscriptionTab"])();
...
/*!********************************!*\
  !*** ./js/subscription-tab.js ***!
  \********************************/
/*! exports provided: changeSubscriptionTab */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "changeSubscriptionTab", function() { return changeSubscriptionTab; });
var subscriptionTabSection = document.querySelector('[data-tab-section]'); // Кнопки для переключения табов

var subscriptionTabButtons = document.querySelectorAll('[data-tab-button]'); // Контент табов

var subscriptionTabContents = document.querySelectorAll('[data-tab-content]'); // Название активного таба

var tabName;

var changeSubscriptionTab = function changeSubscriptionTab() {
  ...
  var onTabButtonClick = function onTabButtonClick(evt) {
    if (evt.target.matches('[data-tab-button]')) {
      if (!evt.target.classList.contains('is-active')) {
        subscriptionTabButtons.forEach(function (button) {
  ...
  function selectTabContent(tab) {
    subscriptionTabContents.forEach(function (content) {
...
/*!**********************!*\
  !*** ./js/vendor.js ***!
  \**********************/
/*! exports provided: checkReviewsSwiper, checkCoachSwiper */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "checkReviewsSwiper", function() { return checkReviewsSwiper; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "checkCoachSwiper", function() { return checkCoachSwiper; });
...
var coachSwiper = document.querySelector('.coach__slider'); // const coachSwipers = sectionCoach.querySelector('.swiper');

var reviewsSwiper = document.querySelector('.reviews__slider'); // const reviewsSwipers = sectionReviews.querySelector('.swiper');
